...
RANGE_STOCKS = {
    '600000': '浦发银行', '600015': '华夏银行', '000001': '平安银行', '600008': '上港集团','601298': '青岛港',
    '600269': '赣粤高速', '000429': '粤高速A',  '001965': '招商公路', '600350': '山东高速',
    '601006': '大秦铁路', '600377': '宁沪高速', '601166': '兴业银行',
    '000651': '格力电器', '600023': '浙能电力', '000543': '皖能电力',
    '600958': '东方证券', '300059': '东方财富', '600570': '恒生电子',
}

TREND_STOCKS = {
    '600690': '海尔智家', '000921': '海信家电', '002415': '海康威视',
    '600660': '福耀玻璃', '000333': '美的集团',
}
...
HOLD_STOCKS = {
    ...
    '600028': '中国石化', '512890': '红利低波', '510500': '中证500ETF',
}
...
def get_market_prefix(code: str) -> str:
    ...
    if c.startswith(('6', '9', '5')): return 'sh'
...
def build_markdown_message(signals: Dict, is_friday: bool, target_date: str) -> Optional[Tuple[str, str]]:
    ...
    if has_signals:
        title = f"Testing {target_date} 白马股均线偏离预警"
    elif is_friday:
        title = f"Testing {target_date} 白马股周度汇总"
    else:
        return None
